...
assert.match(RELATIONSHIP_FUNNEL_V2_PAGE, /datetime="2026-09-10T20:35:09\.847Z"/);
assert.match(RELATIONSHIP_FUNNEL_V2_PAGE, /Первый полный день новой версии по Риге — 11 сентября/);
assert.match(RELATIONSHIP_FUNNEL_V2_PAGE, /10 сентября включает три версии/);
assert.match(RELATIONSHIP_FUNNEL_V2_PAGE, /103 посещения → 5 нажатий \(4,85%\)/);
