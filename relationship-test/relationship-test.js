...
const variants = {
  ...
  d: {
    ...
    leadHtml: "<span>Вы тянете на себе быт, детей и сами отношения. Раздражает даже его голос, близости всё меньше, а муж всё чаще кажется ещё одним ребёнком.</span><span>Возможно, дело не только в усталости. За 3 минуты тест покажет, в каком сценарии вы оказались, почему берёте на себя слишком много и почему между вами растёт дистанция.</span><span class=\"hero__lead-emphasis\">Понять свой сценарий — первый шаг к тому, чтобы изменить отношения и снова почувствовать себя в них женщиной.</span>",
