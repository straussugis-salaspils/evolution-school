...
const variants = {
  ...
  d: {
    ...
    title: "Я устала всё тянуть на себе — или больше не хочу этих отношений?",
    titleHtml: "Я устала всё тянуть на себе — <span class=\"title-accent\">или больше не хочу этих отношений?</span>",
    lead: "Когда рядом с мужем остаются только обязанности, легко перепутать усталость, обиды и потерю близости. Ответьте на 7 вопросов — получите разбор своей ситуации и ориентиры перед решением.",
