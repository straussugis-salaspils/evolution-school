...
const variants = {
  ...
  d: {
    ...
    lead: "Муж раздражает, близости не хочется, всё чаще думаете: зачем мне такие отношения? Пройдите тест из 7 вопросов, чтобы разобраться, что стоит за этими чувствами и что важно понять перед решением — уйти или остаться.",
