...
const variants = {
  ...
  d: {
    ...
    title: "Я разлюбила мужа — или просто устала всё тащить на себе?",
    titleHtml: "Я разлюбила мужа —<br>или просто устала <span class=\"title-accent\">всё тащить на себе?</span>",
    lead: "Муж раздражает, близости не хочется, всё чаще думаете: зачем мне такие отношения? Пройдите 7 вопросов, чтобы разобраться, что стоит за этими чувствами и что важно понять перед решением — уйти или остаться.",
    author: "Светлана Страусс · 26 лет в отношениях",
    ctaLabel: "ПРОЙТИ ТЕСТ В TELEGRAM",
    nextStepHtml: "Откроется Telegram-канал <strong>«Архетипы в Отношениях»</strong>. Вступите в канал и откройте тест в закреплённом посте.",
    telegramUrl: "https://t.me/RelationshipArchetypes"
  }
};
