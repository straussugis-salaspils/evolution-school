...
const variants = {
  ...
  d: {
    ...
    title: "Я разлюбила мужа — или просто устала?",
    titleHtml: "Я разлюбила мужа —<br>или <span class=\"title-accent\">просто устала?</span>",
    lead: "Получите разбор по вашим ответам: почему вам плохо в отношениях, как возникает эта ситуация и что важно понять перед решением — уйти или остаться.",
    ctaLabel: "ПРОЙТИ ТЕСТ ЗА 3 МИНУТЫ",
    nextStepHtml: "Тест в Telegram: вступите в канал и откройте закреплённый пост.",
    telegramUrl: "https://t.me/RelationshipArchetypes"
  }
};
