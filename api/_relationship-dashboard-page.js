    ...
    <main>
      ...
      <section class="change-log" aria-labelledby="change-log-title">
        ...
        <ol>
          ...
          <li><time datetime="2026-08-31">31 августа 2026</time><div><strong>Добавили подсказку про запуск Telegram-бота</strong><p>Под основной кнопкой на обоих лендингах теперь явно написано: после перехода в Telegram нужно нажать «Запустить» / Start. Изменение направлено на снижение потерь между кликом по CTA и фактическим TelegramStart.</p></div></li>
          <li><time datetime="2026-08-31">31 августа 2026</time><div><strong>Подтвердили живую конверсию в Meta</strong><p>После исправления внутренняя статистика показывает 7 фактических вступлений: A — 3, B — 4. Events Manager увидел 4 Complete registration, а Ads Manager засчитал REL-B одну Website Completed Registration стоимостью $11.</p></div></li>
          <li><time datetime="2026-08-31">31 августа 2026</time><div><strong>Сделали вступление в группу канонической конверсией</strong><p>Подтверждённый Telegram join теперь сохраняется независимо от финальной CTA. Фоновая сверка показывает уже состоящих в группе отдельно, но без известной даты не записывает их как новые вступления. Meta CompleteRegistration создаётся только по факту group_joined и без дублей.</p></div></li>
          <li><time datetime="2026-08-31">31 августа 2026</time><div><strong>Проверили качество Meta-атрибуции</strong><p>Для всех отправляемых событий подтверждены уникальные и валидные fbc, IP и User-Agent. Две регистрации кампаний 29–30 августа точечно отправлены повторно с прежними event_id для проверки появления CompleteRegistration в Events Manager.</p></div></li>
