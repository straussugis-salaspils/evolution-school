  ...
  <div class="shell">
    ...
    <main>
      ...
      <section class="change-log" aria-labelledby="change-log-title">
        ...
        <ol>
          <li><time datetime="2026-09-06T10:46:47+03:00">6 сентября 2026 · 10:46, Рига</time><div><strong>Нашли двойной подсчёт Meta-регистраций</strong><p>Контрольный срез: Meta показывала 27 CompleteRegistration, внутренняя статистика — 21 уникальное нажатие по всем источникам и 6 фактических вступлений; в канале 169 подписчиков. Events Manager подтвердил одновременную отправку Browser и Server. Серверный CompleteRegistration отключён, браузерный пиксель ограничен одним событием на сессию. Исторические 27 остаются завышенными; корректно сравнивать новые результаты после этой отметки.</p></div></li>
