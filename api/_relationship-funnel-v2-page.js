...
<body>
  <div class="shell">
    ...
    <main>
      ...
      <section class="report-section" aria-labelledby="youtube-copy-change-title">
        <h2 id="youtube-copy-change-title">Новая версия YouTube-лендинга · «Я разлюбила мужа — или просто устала?»</h2>
        <p>Заголовок «Я разлюбила мужа — или просто устала всё тащить на себе?» и тёмный шаблон с изображением пары опубликованы <time datetime="2026-09-10T20:35:09.847Z">10 сентября 2026 в 23:35:09 по Риге / 11 сентября в 00:35:09 по Дубаю</time>. В отчёте это прежняя строка «Уставшая функция · YouTube». По Риге 10 сентября включает три версии: исходную до 17:29:26, промежуточную с портретом до 23:35:09 и новую с парой после 23:35:09. Первый полный день новой версии по Риге — 11 сентября. Период ниже выбирает целые дни, не точное время публикации.</p>
        <p>Промежуточная версия с портретом, Google / YouTube, 10 сентября 17:29:26–23:35:09 по Риге: 103 посещения → 5 нажатий (4,85%) → 0 вступлений → 0 начал → 0 завершений. Снимок на 23:35:38; поздние действия могут дополнить прежнюю когорту. Новая версия сравнивается отдельно с промежуточной и исходной; события и идентификатор лендинга сохранены.</p>
        <p>База Google / YouTube за 6–9 сентября по Риге, снимок на 10 сентября 17:30:47: 1326 посещений → 77 нажатий (5,81%) → 22 вступления (1,66%) → 8 начал → 6 завершений теста (0,45% посещений). Сравниваем прежде всего долю вступлений и завершений, не только клики. Это сравнение до/после, не A/B-тест; поздние действия и технические исправления 10 сентября также могут влиять на результат.</p>
      </section>
      ...
      <section class="change-log" aria-labelledby="change-log-title">
        ...
        <ol>
          <li><time datetime="2026-09-10T20:35:09.847Z">10 сентября 2026 · 23:35:09, Рига</time><div><strong>Заменили YouTube-лендинг: разлюбила или устала?</strong><p>Поставили согласованный заголовок «Я разлюбила мужа — или просто устала всё тащить на себе?» и текст про раздражение, отсутствие близости и решение «уйти или остаться». Использовали существующий тёмный шаблон и изображения мужчины и женщины из двух других лендингов. Тест B, URL, Telegram-канал, рекламные кампании, идентификаторы и обработчики аналитики не менялись. Точная граница сравнения — время исходного посещения; до неё промежуточная версия получила 103 посещения Google / YouTube и 5 нажатий.</p></div></li>
          <li><time datetime="2026-09-10T14:29:26.387Z">10 сентября 2026 · 17:29:26, Рига</time><div><strong>Переписали YouTube-лендинг и зафиксировали точку сравнения</strong><p>Новый заголовок: «Я устала всё тянуть на себе — или больше не хочу этих отношений?». Объяснили пользу 7 вопросов и прямо указали переход в Telegram. URL, фото, тест, путь через канал и события аналитики не менялись. Сохранён снимок старой версии; для точного разделения используется время исходного посещения, а не дата последующего действия. Первый полный день новой версии — 11 сентября.</p></div></li>
  ...
  <script>
    (function () {
      ...
      function renderOperational(data) {
        ...
        var notes=[];
        notes.push('Проверено в Meta 10 сентября: домен отнесён к категории Religion, пересмотр отклонён 8 сентября. Для посетителей Европейского региона Meta может блокировать передачу данных; в остальных регионах действует core setup. Ответ «Meta приняла» не снимает это ограничение. Повторный пересмотр сейчас недоступен.');
