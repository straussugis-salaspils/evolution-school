  ...
  <div class="shell">
    ...
    <main>
      ...
      <section class="report-section" aria-labelledby="youtube-copy-change-title">
        <h2 id="youtube-copy-change-title">Новый текст YouTube-лендинга · 10 сентября</h2>
        <p>Опубликован <time datetime="2026-09-10T14:29:26.387Z">10 сентября 2026 в 17:29:26 по Риге / 18:29:26 по Дубаю</time>. В отчёте это прежняя строка «Уставшая функция · YouTube». Данные за 10 сентября включают обе версии; первый полный день нового текста — 11 сентября. Период ниже выбирает целые дни, не точное время публикации.</p>
